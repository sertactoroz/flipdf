          ...
          <div class="w-full px-4">
            ...
            >
              ...
              <form id="signup-form">
                ...
                <div class="mb-6">
                  <input
                    ...
                    required
                    />
                    <i  class="far fa-eye" id="signup-toggle-password"></i>
                </div>
                ...
                <div class="mb-6">
                  <input
                    ...
                    autocomplete="on"
                    class="bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none transition focus:border-primary focus-visible:shadow-none"
                    title="Paswords do not match " 
                    required
                    />
                </div>
                <div
                id="signup-response-message">
              </div>
                <div id="invalid-password-message" >
                  <h3>Password must contain the following:</h3>
                  <p id="letter" class="invalidPassword invalid">A <b>lowercase</b> letter</p>
                  <p id="capital" class="invalidPassword invalid">A <b>capital (uppercase)</b> letter</p>
                  <p id="number" class="invalidPassword invalid">A <b>number</b></p>
                  <p id="length" class="invalidPassword invalid">Minimum <b>8 characters</b></p>
                </div>
                <div class="mb-10">
                  <input
                   disabled
              ...
              <p class="text-base text-[#adadad]">
                ...
                <a href="../screens/signin-screen.php" class="text-primary hover:underline">
                  Sign In
                </a>
              </p>
